...
# Verified YouTube IDs (Organic Chemistry Tutor + selected partners). Thumbnails: i.ytimg.com
ENRICH_VIDEO_PATCHES = {
    "resonance-acid-base-review": {
        "overviewVideoId": "OqsOIp5UuME",
        "mustKnowItems": [
            mki("Resonance basics", "Only π bonds and lone pairs move; atoms stay fixed.", "OqsOIp5UuME"),
            mki("Drawing resonance structures", "Practice curved arrows without moving σ bonds.", "klAT2MACt4Q"),
            mki("pKa and acid strength", "Lower pKa = stronger acid; use tables to set equilibrium.", "IQ6gHQAg_Nk"),
            mki("EWG/EDG effects on acidity", "Withdrawers stabilize anions; donors destabilize them.", "F7mbfPmOugY"),
        ],
    },
    "substitution-elimination-nmr-review": {
        "overviewVideoId": "yrvV85H737o",
        "mustKnowItems": [
            mki("SN2 requirements", "1° substrate, strong Nu, polar aprotic solvent.", "yrvV85H737o"),
            mki("SN1 requirements", "3° substrate, weak Nu, protic solvent.", "qTc2uud7TVU"),
            mki("Tosylate strategy", "TsCl activates –OH without breaking C–O at carbon.", "4PDs3ygNsv4"),
            mki("NMR key shifts", "δ, integration, and splitting for exam spectra.", "MhiiIKpm5Xw"),
            mki("Chemical shift", "Electron density and functional group trends.", "2QBDNxiGsAY"),
            mki("Spin-spin splitting", "n+1 rule and coupling patterns.", "WJKfl3w52Mk"),
        ],
    },
    "alkynes": {
        "overviewVideoId": "zFSHoaScfwY",
        "mustKnowItems": [
            mki("Double addition of Br2", "One equiv → vinyl dibromide; two equiv → tetrahalide.", "zFSHoaScfwY"),
            mki("Hydration (Markovnikov)", "Hg²⁺/H₂SO₄/H₂O → enol → ketone.", "zFSHoaScfwY"),
            mki("Hydration (anti-Markovnikov)", "Hydroboration–oxidation → aldehyde from terminal alkyne.", "zFSHoaScfwY"),
            mki("Reduction to alkenes", "Lindlar (cis) vs Na/NH₃ (trans).", "zFSHoaScfwY"),
            mki("Acetylide alkylation", "NaNH₂ then 1° alkyl halide only.", "I85LgmfkJ0o"),
            mki("Oxidative cleavage", "KMnO₄ cleavage patterns.", "zFSHoaScfwY"),
        ],
    },
    "grignard-reaction": {
        "overviewVideoId": "X5I2vG576QA",
        "mustKnowItems": [
            mki("Grignard formation", "Mg, dry ether; handle under anhydrous conditions.", "X5I2vG576QA"),
            mki("Addition to carbonyls", "RMgX + carbonyl → alcohol after H₃O⁺.", "X5I2vG576QA"),
            mki("Incompatible groups", "Protic acids and O–H destroy the reagent.", "X5I2vG576QA"),
            mki("Gilman reagent", "R₂CuLi: selective 1,4 and ketone from acid chloride.", "I85LgmfkJ0o"),
            mki("Suzuki-Miyaura", "Pd-catalyzed C–C coupling overview.", "I85LgmfkJ0o"),
        ],
    },
    "organohalides-radical": {
        "overviewVideoId": "T_FcOcX3wsQ",
        "mustKnowItems": [
            mki("Alcohol to alkyl halide", "PBr₃, SOCl₂, and HX tradeoffs.", "4PDs3ygNsv4"),
            mki("Radical mechanism", "Initiation → propagation → termination.", "T_FcOcX3wsQ"),
            mki("NBS allylic bromination", "Selective allylic/benzylic positions.", "T_FcOcX3wsQ"),
            mki("Radical stability", "Allylic/benzylic > 3° > 2° > 1°.", "T_FcOcX3wsQ"),
            mki("Peroxide effect (HBr)", "Anti-Markovnikov radical addition.", "ZMcCvD5dDMU"),
        ],
    },
    "conjugated-compounds-diels-alder": {
        "overviewVideoId": "sBmoP6KwK-8",
        "mustKnowItems": [
            mki("Conjugated vs isolated", "π overlap lowers energy vs isolated dienes.", "sBmoP6KwK-8"),
            mki("1,2 vs 1,4 addition", "Kinetic (low T) vs thermodynamic (high T) control.", "BlTDF_7IaBA"),
            mki("Diels-Alder reaction", "s-cis diene + electron-deficient dienophile.", "sBmoP6KwK-8"),
            mki("Stereochemistry", "Suprafacial [4+2] preserves dienophile geometry.", "ak-6eMoxRSg"),
        ],
    },
    "aromaticity": {
        "overviewVideoId": "1841E4NmsHQ",
        "mustKnowItems": [
            mki("4 criteria for aromaticity", "Cyclic, planar, conjugated, 4n+2 π e⁻.", "1841E4NmsHQ"),
            mki("Aromatic vs antiaromatic", "Hückel rule and planarity.", "7-BguH4_WBQ"),
            mki("Pyridine vs pyrrole basicity", "Where the lone pair lives relative to π.", "s4dSPIhK_ZI"),
            mki("Heterocycles", "Electron counting in furan, thiophene, pyrrole.", "ZztpEXSAVrM"),
        ],
    },
    "electrophilic-aromatic-substitution": {
        "overviewVideoId": "ubtvxTvdWjA",
        "mustKnowItems": [
            mki("EAS two steps", "σ complex then deprotonation restores aromaticity.", "ubtvxTvdWjA"),
            mki("5 EAS reactions", "Halogenation, nitration, sulfonation, FC alkylation/acylation.", "ubtvxTvdWjA"),
            mki("Directing effects", "Ortho/para vs meta from resonance.", "ubtvxTvdWjA"),
            mki("Friedel-Crafts alkylation", "Carbocation chemistry; rearrangement risk.", "ubtvxTvdWjA"),
            mki("Friedel-Crafts acylation", "Ketone product; no rearrangement.", "ubtvxTvdWjA"),
        ],
    },
    "nucleophilic-aromatic-substitution": {
        "overviewVideoId": "eQzbpL0uWVA",
        "mustKnowItems": [
            mki("NAS requirements", "EWG ortho/para to leaving group.", "eQzbpL0uWVA"),
            mki("NAS vs EAS", "Electron-rich vs electron-poor aromatic rings.", "ubtvxTvdWjA"),
            mki("Benzyne mechanism", "Strong base on unactivated aryl halides.", "H7l7Prf5cjc"),
            mki("Side-chain reactions", "Benzylic oxidation and halogenation.", "T_FcOcX3wsQ"),
        ],
    },
    "alcohols-phenols": {
        "overviewVideoId": "K07VceUan0k",
        "mustKnowItems": [
            mki("Reducing agents", "NaBH₄ vs LiAlH₄ scope.", "5MboymSRLn4"),
            mki("Oxidation levels", "1° → aldehyde → acid; 2° → ketone.", "K07VceUan0k"),
            mki("Tosylate strategy", "TsCl/pyridine; retention at stereocenter.", "4PDs3ygNsv4"),
            mki("Phenol acidity", "Resonance stabilization of phenoxide.", "MAjy2WMkPHc"),
        ],
    },
    "ethers-epoxides": {
        "overviewVideoId": "mNOYdafN5TI",
        "mustKnowItems": [
            mki("Williamson synthesis", "Alkoxide + 1° RX; avoid 3° halide.", "mNOYdafN5TI"),
            mki("Ether cleavage", "HBr/HI mechanisms.", "NpABmoc8MJY"),
            mki("Epoxide synthesis", "mCPBA syn epoxidation.", "Uq532aH3OTY"),
            mki("Ring opening acid/base", "Acid: more substituted C; base: less substituted.", "9zsJhrG-9WY"),
        ],
    },
    "aldehydes-ketones": {
        "overviewVideoId": "wmXxrxZ6PVU",
        "mustKnowItems": [
            mki("Cyanohydrin", "CN⁻ addition to carbonyl.", "wmXxrxZ6PVU"),
            mki("Imine and enamine", "1° vs 2° amine outcomes; pH window.", "_0C7XXWjOpQ"),
            mki("Wolff-Kishner", "Hydrazone then strong base/heat.", "yUefif10Z_M"),
            mki("Acetal formation", "Protection/deprotection equilibrium.", "wmXxrxZ6PVU"),
            mki("Wittig reaction", "Phosphonium ylide forms new C=C.", "jxUXIHG1zGc"),
        ],
    },
    "carboxylic-acids-derivatives": {
        "overviewVideoId": "5PK63QjP03k",
        "mustKnowItems": [
            mki("Reactivity order", "Acid chloride > anhydride > ester > amide.", "5PK63QjP03k"),
            mki("Acyl substitution", "Tetrahedral intermediate; LG basicity.", "5PK63QjP03k"),
            mki("Fischer esterification", "Equilibrium with water/alcohol.", "l_WuC4vpTsY"),
            mki("Acid chloride SOCl2", "–COOH → –COCl.", "5PK63QjP03k"),
            mki("Ester reactions", "Hydrolysis, transesterification, reduction.", "l_WuC4vpTsY"),
            mki("Amide reactions", "Hydrolysis difficulty vs esters.", "5PK63QjP03k"),
        ],
    },
}
