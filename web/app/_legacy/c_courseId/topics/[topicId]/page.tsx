          ...
          <div className="stack">
            <div>
              ...
              <div className="subtle">
                courseId {JSON.stringify(params.courseId)} topicId {JSON.stringify(params.topicId)}
              </div>
            </div>
            <Link className="btn" href={`/c/${params.courseId}`}>
              Back to topics
            </Link>
          </div>
        </div>
    ...
    <div className="card" style={{ width: "100%", maxWidth: 980 }}>
      <div className="cardInner">
        <div className="stack">
          ...
          <div className="row">
            <Link className="btn" href={`/c/${course.id}`}>
              Back to topics
            </Link>
